# :keycap_ten: Clase 10 - Soberania y Autocustodia
...
Riesgos del exchange:
- :x: Hackeos y robos
- :x: Bancarrota (Mt.Gox, FTX)
...
[:arrow_left: Clase 9](es/clase-9.md) | [:house: Volver a Introduccion](es/intro.md)
