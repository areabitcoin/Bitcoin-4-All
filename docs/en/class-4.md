...
You can check out Bitcoin's github, where developers debate updates and where you can also contribute if you want. I'll leave the [Github](https://github.com/bitcoin/bitcoin) link here below the class. The code works through software and the most used is Bitcoin Core, an implementation of the original version created by Satoshi Nakamoto.
