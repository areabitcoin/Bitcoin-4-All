...
| Feature | Description |
|---------|-------------|
| **10 Complete Classes** | From basics to advanced topics |
| **3 Languages** | Portuguese, English, Spanish |
| **Ready Materials** | Scripts, slides, ebooks |
| **Open Source** | Freely adapt and distribute |
| **Meetup Ready** | Perfect for local events |

## :busts_in_silhouette: Who is this for?

- **Beginners** wanting to learn about Bitcoin
- **Educators** wanting to teach Bitcoin
